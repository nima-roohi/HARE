...
FLOW (* jumps are enforced by the bound [0, 1] on the clock *)
  m1{height_d>=-0.5/\height_d<=0.5}{2*hfiltered_d=height-hfiltered}{clock_d=1}
  m2{height_d>=0.5/\height_d<=2.5}{2*hfiltered_d=height-hfiltered}{clock_d=1} (* air is pressed into suspension *)
  m3{height_d>=-2.5/\height_d<=-0.5}{2*hfiltered_d=height-hfiltered}{clock_d=1} (* air is let out of suspensions *)
  m4{height_d>=0.5/\height_d<=2.5}{2*hfiltered_d=height-hfiltered}{clock_d=1} (* air is pressed into suspension *)
  m5{height_d>=-2.5/\height_d<=-0.5}{2*hfiltered_d=height-hfiltered}{clock_d=1} (* air is let out of suspensions *)
JUMP
